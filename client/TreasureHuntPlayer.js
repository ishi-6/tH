...
export default class TreasureHuntPlayer extends Phaser.GameObjects.Container {
    ...
    constructor(scene, x, y) {
        ...
        // username
        const username = scene.add.text(-7, 19, "", {});
        ...
        // spade_1
        const spade_1 = scene.add.image(270, 14, "treasurehunt", "spade0001");
        spade_1.setOrigin(0, 0);
        this.add(spade_1);

        // spade_2
        const spade_2 = scene.add.image(305, 14, "treasurehunt", "spade0001");
        spade_2.setOrigin(0, 0);
        this.add(spade_2);

        // spade_3
        const spade_3 = scene.add.image(340, 14, "treasurehunt", "spade0001");
        spade_3.setOrigin(0, 0);
        this.add(spade_3);

        // spade_4
        const spade_4 = scene.add.image(375, 14, "treasurehunt", "spade0001");
        spade_4.setOrigin(0, 0);
        this.add(spade_4);

        // spade_5
        const spade_5 = scene.add.image(410, 14, "treasurehunt", "spade0001");
        spade_5.setOrigin(0, 0);
        this.add(spade_5);

        // spade_6
        const spade_6 = scene.add.image(445, 14, "treasurehunt", "spade0001");
    ...
    updateSpades() {    
        ...
        this.spades[this.moves-1].setFrame(`spade0002`)
        this.moves -=1
    }
    ...
    setSpades() {       // to default
        for(let spade in this.spades){
            this.spades[spade].setFrame(`spade0001`)
        }
    }
    getSpades(){
        return this.spades
